...
BOT_TOKEN = environ.get('BOT_TOKEN', "6554020273:AAGIMRwB-BUopoBmDv-PKwCjsBvRsIsX8EQ")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001748572062').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sakunaagain:nehalsingh969797@cluster0.d8lvuik.mongodb.net/?retryWrites=true&w=majority")
